    ...
    def color_filter(self, number, search_color, plus_minus, section_data):
        ...
        for y in range(y_start, y_end, self.scale_down):
            ...
            for x in range(x_start, x_end, self.scale_down):
                ...
                # print(current_color)
                sum_list = [1 if self.check_value(current_color[idx], search_color[idx], plus_minus) else 0 for idx in range(3)]
...
if __name__ == '__main__':
    scale_down = 3 # this helps scale down the org image, larger num = smaller image... multiply it back to get true pixel positions
    ...
    key_1 = {0: {"color": black_ground, "+-": 0, "section_data": None},
    ...
    key_2 = {0: {"color": black_ground, "+-": 0, "section_data": None},
           1: {"color": gray_castle, "+-": 5, "section_data": {"divide": [2, 5], "section": [2, 3]}},
    ...
    image_calculator = ImageCalculator(board, key_2, scale_down=scale_down)
    ...
    obj = image_calculator.retrieve_object_data()
    p = [85, 197]
    q = [111, 250]
    obj[8] = {"center": p}
    obj[9] = {"center": q}
    print(obj[8]["center"])
    print(obj)
    display_pg_window(board, key_2, 'screenshot_1.png', horizontal_sections=10, vertical_sections=3, object_data=obj, circle_size=4)
